...
function start() {
  return inquirer
    .prompt({
      ...
      type: "list",
      message:
        "Would you like to [ADD] a department, role, or employee, [VIEW] current departments, rolls, or employees lists, [UPDATE] a current employee, or [EXIT]?",
...
function addOption() {
  return inquirer
    .prompt({
      ...
      type: "list",
      message:
        "Would you like to add an [EMPLOYEE], a [ROLE], a [DEPARTMENT], or [EXIT]?",
    ...
    return inquirer
      .prompt([
        ...
        },
        {
          ...
          type: "list",
          message:
            "Are they a [1. LEAD ENGINEER], [2. SOFTWARE ENGINEER], [3.LEAD SALES ], [4.SALE REPRESENTATIVE ], [5. LEAD LEGAL ADVISOR], [6. LAWYER]?",
          choices: [1, 2, 3, 4, 5, 6],
        },
        {
  ...
  return inquirer
    .prompt([
      ...
      },
      {
        ...
        type: "list",
        message:
          "Which department does this role belong to? [1. ENGINEERING], [2. LEGAL], or [3. SALES ]",
        choices: [1, 2, 3],
      },
    ])
    .then((answer) => {
...
function viewOption() {
  return inquirer
    .prompt({
      ...
      type: "list",
      message:
        "Would you like the list of [EMPLOYEES], [ROLES], [DEPARTMENTS], or [EXIT]?",
